      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Edit Poumum</h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('poumum/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
...
<div class="form-group">
  ...
  <div class="col-sm-7">
    <input type="text" class="form-control" id="customer_name_1" name="customer_name" value="<?php echo $poumum_data['poumum']['customer_name'] ?>" placeholder="Enter Customer Address" autocomplete="off">
  </div>
</div>
<div class="form-group">
  <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Customer Address</label>
  <div class="col-sm-7">
    <input type="text" class="form-control" id="customer_address_1" name="customer_address" value="<?php echo $poumum_data['poumum']['customer_address'] ?>" placeholder="Enter Customer Address" autocomplete="off">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-sm-7">
    <input type="text" class="form-control" id="customer_phone_1" name="customer_phone" value="<?php echo $poumum_data['poumum']['customer_phone'] ?>" placeholder="Enter Customer Phone" autocomplete="off">
  </div>
</div>
<div class="form-group">
  <label for="fax" class="col-sm-5 control-label" style="text-align:left;">FAX</label>
  <div class="col-sm-7">
    <input type="text" class="form-control" id="fax_1" name="fax" value="<?php echo $poumum_data['poumum']['fax'] ?>" placeholder="Enter Customerfax" autocomplete="off">
  </div>
</div>
<div class="form-group">
  <label for="attn" class="col-sm-5 control-label" style="text-align:left;">Atas Nama</label>
  <div class="col-sm-7">
    <input type="text" class="form-control" id="attn_1" name="attn" value="<?php echo $poumum_data['poumum']['attn'] ?>" placeholder="Enter attn" autocomplete="off">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-sm-7">
    <input type="text" class="form-control" id="pono" name="pono" value="<?php echo $poumum_data['poumum']['pono'] ?>" placeholder="Enter PO No." autocomplete="off">
  </div>
</div>
<div class="form-group">
  <label for="deliverydate" class="col-sm-5 control-label" style="text-align:RIGHT;">Delivery Date</label>
  <div class="col-sm-7">
    <input type="date" class="form-control" id="deliverydate" name="deliverydate"  value="<?php echo $poumum_data['poumum']['deliverydate'] ?>"placeholder="Enter Date" autocomplete="off">
  </div>
</div>
<div class="form-group">
  <label for="deliverydate" class="col-sm-5 control-label" style="text-align:RIGHT;">Date Created</label>
  <div class="col-sm-7">
  <input type="date" class="form-control" id="date_time" name="date_time" placeholder="Enter Date" autocomplete="off">
             			
  </div>
          </div>
  <div class="form-group">
                    <label for="paid_status" class="col-sm-5 control-label">Status PO Compound</label>
                    <div class="col-sm-7">
                ...
                <table class="table table-bordered" id="product_info_table">
                  <thead>
                   ...
                   <tbody>
                    ...
                    <?php if(isset($poumum_data['poumum_item'])): ?>
                      <?php $x = 1; ?>
                      <?php foreach ($poumum_data['poumum_item'] as $key => $val): ?>
                        <?php //print_r($v); ?>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="gross_amount" name="gross_amount" disabled value="<?php echo $poumum_data['poumum']['gross_amount'] ?>" autocomplete="off">
                      <input type="hidden" class="form-control" id="gross_amount_value" name="gross_amount_value" value="<?php echo $poumum_data['poumum']['gross_amount'] ?>" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="service_charge" name="service_charge" disabled value="<?php echo $poumum_data['poumum']['service_charge'] ?>" autocomplete="off">
                      <input type="hidden" class="form-control" id="service_charge_value" name="service_charge_value" value="<?php echo $poumum_data['poumum']['service_charge'] ?>" autocomplete="off">
                    </div>
                  </div>
                  <?php endif; ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="vat_charge" name="vat_charge" disabled value="<?php echo $poumum_data['poumum']['vat_charge'] ?>" autocomplete="off">
                      <input type="hidden" class="form-control" id="vat_charge_value" name="vat_charge_value" value="<?php echo $poumum_data['poumum']['vat_charge'] ?>" autocomplete="off">
                    </div>
                  </div>
                  <?php endif; ?>
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="discount" name="discount" placeholder="Discount" onkeyup="subAmount()" value="<?php echo $poumum_data['poumum']['discount'] ?>" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="net_amount" class="col-sm-5 control-label">Net Amount</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="net_amount" name="net_amount" disabled value="<?php echo $poumum_data['poumum']['net_amount'] ?>" autocomplete="off">
                      <input type="hidden" class="form-control" id="net_amount_value" name="net_amount_value" value="<?php echo $poumum_data['poumum']['net_amount'] ?>" autocomplete="off">
                    </div>
                  </div>
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo base_url() . 'poumum/printDiv/'.$poumum_data['poumum']['id'] ?>" class="btn btn-default" >Print</a>
                <button type="submit" class="btn btn-primary">Save Changes</button>
                <a href="<?php echo base_url('poumum/') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#mainPoumumNav").addClass('active');
    $("#managePoumumNav").addClass('active');
    ...
    $("#add_row").unbind('click').bind('click', function() {
      ...
      $.ajax({
          url: base_url + '/poumum/getTableProductRow/',
          type: 'post',
          dataType: 'json',
          success:function(response) {
               ...
               var html = '<tr id="row_'+row_id+'">'+
                   '<td>'+ 
                    '<select class="form-control select_group product" data-row-id="'+row_id+'" id="product_'+row_id+'" name="product[]" style="width:100%;" onchange="getProductData('+row_id+')">'+
                      ...
                      html += '</select>'+
                    '</td>'+ 
                    '<td><input type="text" name="name[]" id="name_'+row_id+'" class="form-control"><input type="hidden" name="name_value[]" id="name_value_'+row_id+'" class="form-control"></td>'+
                    ...
                    '<td><input type="number" name="note[]" id="note_'+row_id+'" class="form-control" onkeyup="getTotal('+row_id+')"></td>'+
  ...
  function getProductData(row_id)
  {
    ...
    if(product_id == "") {
      ...
      $.ajax({
        url: base_url + 'poumum/getProductValueById',
        type: 'post',
  ...
  function getVroductData(rw_id)
  {
	...
	$("#customer_name_"+rw_id).val("");
      ...
      $.ajax({
        url: base_url + 'Poumum/getVroductValueById',
        type: 'post',
