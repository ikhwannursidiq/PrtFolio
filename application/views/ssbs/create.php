    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">SELEKSI SUPPLIER BARU</h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('ssbs/create') ?>" method="post" class="form-horizontal" name="autoSumForm" >
              <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="date" class="form-control" id="tgl" name="tgl" placeholder="Enter nama perusahaan" autocomplete="off" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Nama perusahaan</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="namaperusahaan" name="namaperusahaan" placeholder="Enter namaperusahaan" autocomplete="off" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="alamatkantorpusat" class="col-sm-5 control-label" style="text-align:left;">alamat kantor pusat</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="alamatkantorpusat" name="alamatkantorpusat" placeholder="Enter alamat kantor pusat" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="alamatkantorcabang" name="alamatkantorcabang" placeholder="Enter alamat kantor cabang" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Telephone</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="telp" name="telp" placeholder="Enter Telp" autocomplete="off" />
                    </div>
                  </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="date" class="form-control" id="datecreated" name="datecreated" placeholder="Enter " autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="fax" name="fax" placeholder="Enter FAX" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="attn" name="attn" placeholder="Enter contak person" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Nama Barang</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="namabarang" name="namabarang" placeholder="Enter nama barang" autocomplete="off" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Kriteria seleksi</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="kriteriaseleksi" name="kriteriaseleksi" placeholder="Enter Seleksi" autocomplete="off" />
                    </div>
                  </div>
      ...
      <tbody>
          <tr id="row_1">
              ...
              <td  align="center"  bgcolor="#FFDAB9"><input type="text" name="npwp" id="npwp" class="form-control-sm text-right item" value=""></td>
          </tr>
          <tr id="row_1">
              ...
              <td   align="center" bgcolor="#FFDAB9"><input type="text" name="siup" id="siup" class="form-control-sm text-right item" value=""></td>
          </tr> <tr id="row_1">
              ...
              <td  align="center"  bgcolor="#FFDAB9"><label align="center"  >2</td>
              <td  align="center"  bgcolor="#FFDAB9"><input type="text" name="brosur" id="brosur" class="form-control-sm text-right item" value=""></td>
          </tr> <tr id="row_1">
              ...
              <td  align="center"  bgcolor="#FFDAB9"  align="center" ><input type="text" name="dataproduk" id="dataproduk" class="form-control-sm text-right item" value=""></td>
          </tr>   
      ...
      <tr id="row_1">
          ...
          <tr id="row_1">
              ...
              <td align="center" bgcolor="#FFDAB9"><input type="produsen" name="produsen" id="produsen" class="form-control-sm text-right item" value=""></td>
          </tr>
          <tr id="row_1">
              ...
              <td align="center" bgcolor="#FFDAB9"><input type="text" name="agen" id="agen" class="form-control-sm text-right item" value=""></td>
          </tr>
          <tr id="row_1">
              ...
              <td align="center"bgcolor="#FFDAB9"><input type="text" name="perorangan" id="perorangan" class="form-control-sm text-right item" value=""></td>
      </tr>
      ...
      <tr id="row_1">
          ...
          <tr id="row_1">
              ...
              <td align="center" bgcolor="#FFDAB9"><label >15</td>
              <td align="center" bgcolor="#FFDAB9"><input type="text" name="hargasaing" id="hargasaing" class="form-control-sm text-right item" value=""></td>
          </tr>
          <tr id="row_1">
              ...
              <td align="center" bgcolor="#FFDAB9"><input type="text" name="hargapasar" id="hargapasar" class="form-control-sm text-right item" value=""></td>
          </tr>
      ...
      <tr id="row_1">
          ...
          <tr id="row_1">
              ...
              <td align="center" bgcolor="#FFDAB9"><label >2</td>
              <td align="center" bgcolor="#FFDAB9"><input type="text" name="baik" id="baik" class="form-control-sm text-right item" value=""></td>
          </tr>
          <tr id="row_1">
              <td bgcolor="#FFDAB9"><label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">b. Cukup</label></td>
              <td align="center" bgcolor="#FFDAB9"><label >2</td>
              <td align="center" bgcolor="#FFDAB9"><input type="text" name="cukup" id="cukup" class="form-control-sm text-right item" value=""></td>
          </tr>
      ...
      <tr id="row_1">
          ...
          <tr id="row_1">
              ...
              <td align="center"  bgcolor="#FFDAB9"><input type="text" name="dalamkota" id="dalamkota" class="form-control-sm text-right item" value=""></td>
          </tr>
          <tr id="row_1">
              ...
              <td align="center"  bgcolor="#FFDAB9"><input type="text" name="luarkota" id="luarkota" class="form-control-sm text-right item" value=""></td>
          </tr>
          <tr id="row_1">
              
              <td bgcolor="#FFDAB9" ><label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">c. Luar Negri </label></td>
              <td align="center"  bgcolor="#FFDAB9"><label >2</td>
              <td align="center"  bgcolor="#FFDAB9"><input type="text" name="luarnegri" id="luarnegri" class="form-control-sm text-right item" value=""></td>
      </tr>
      ...
      <tr id="row_1">
          ...
          <tr id="row_1">
              ...
              <td align="center"  bgcolor="#FFDAB9"><input type="text" name="lengkap" id="lengkap" class="form-control-sm text-right item" value=""></td>
          </tr>
          <tr id="row_1">
              <td bgcolor="#FFDAB9" ><label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">b. Kurang Lengkap</label></td>
              <td align="center"  bgcolor="#FFDAB9"><label >2</td>
              <td align="center"  bgcolor="#FFDAB9"><input type="text" name="kl" id="kl" class="form-control-sm text-right item" value=""></td>
          </tr>
      <tr id="row_1">
              <td bgcolor="#FFDAB9" rowspan="5" Align ="right"></td>
              <td bgcolor="#FFDAB9"><label >Total Nilai</td>
              <td bgcolor="#FFDAB9"><input readonly  type="text" name="hasil" value="0" id="hasil"  class="form-control-sm text-right item" value="" ></td>
          </tr>  
                ...
                <div class="col-md-6 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                    <input type="textarea" class="form-control" id="kesimpulan" name="kesimpulan" placeholder="kesimpulan" class="form-control-sm text-right item" value="">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                    <textarea class="form-control txt" rows="5" name="note" id="note"  onkeyup="this.value = this.value.toUpperCase()" placeholder="Your Notes"></textarea>
