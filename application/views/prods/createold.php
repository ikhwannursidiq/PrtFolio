  ...
  <th align="center" style="background-color:#52bbef;  width:20% font-size:30px;" colspan="10" >Physical properties of Rubber EPDM </th>
   ...
   <tbody>
     <tr id="row_1">
        ...
        <td>
          <input type="text" value="0" name="jsatu" id="jsatu" class="form-control" >
         </td>
                  ...
                  <thead>
                   ...
                   <tbody>
                     <tr id="row_1">
                        ...
                        <td>
                          <input type="text" value="0" name="jdua" id="jdua" class="form-control" >
                         </td>
                  ...
                  <thead>
                   ...
                   <tbody>
                     <tr id="row_1">
                        ...
                        <td>
                          <input type="text" value="0" name="jtiga" id="jtiga" class="form-control" >
                         </td>
                 <!--       <td><input type="hidden" name="csstandard[]" id="csstandard_1" class="form-control"  ></td>
                        <td>
                          <input type="hidden" name="csfrekuensi[]" id="csfrekuensi_1" class="form-control" >
                  ...
                  <thead>
                   ...
                   <tbody>
                     <tr id="row_1">
                        ...
                        <td>
                          <input type="text" value="0" name="jempat" id="jempat" class="form-control" >
                         </td>
                 <!--       <td><input type="hidden" name="csstandard[]" id="csstandard_1" class="form-control"  ></td>
                        <td>
                          <input type="hidden" name="csfrekuensi[]" id="csfrekuensi_1" class="form-control" >
                  ...
                  <thead>
                   ...
                   <tbody>
                     <tr id="row_1">
                        ...
                        <td>
                          <input type="text" value="0" name="jlima" id="jlima" class="form-control" >
                         </td>
                 <!--       <td><input type="hidden" name="csstandard[]" id="csstandard_1" class="form-control"  ></td>
                        <td>
                          <input type="hidden" name="csfrekuensi[]" id="csfrekuensi_1" class="form-control" >
                  ...
                  <thead>
                   ...
                   <tbody>
                     <tr id="row_1">
                        ...
                        <td>
                          <input type="text" value="0"  name="jenam" id="jenam" class="form-control" >
                         </td>
                 <!--       <td><input type="hidden" name="csstandard[]" id="csstandard_1" class="form-control"  ></td>
                        <td>
                          <input type="hidden" name="csfrekuensi[]" id="csfrekuensi_1" class="form-control" >
          ...
          success:function(response) {
              ...
              // console.log(reponse.x);
               var html = '<tr id="row_'+row_id+'">'+
                  ...
                  '<td><input type="text" value="0" name="satuitem[]" id="satuitem_'+row_id+'" class="form-control" ></td>'+
          ...
          success:function(response) {
              ...
              // console.log(reponse.x);
               var html = '<tr id="row_'+row_id+'">'+
                    ...
                    '<td><input type="text" value="0" name="duaitem[]" id="duaitem_'+row_id+'" class="form-control" ></td>'+
          ...
          success:function(response) {
              ...
              // console.log(reponse.x);
               var html = '<tr id="row_'+row_id+'">'+
                    ...
                    '<td><input type="text" value="0" name="tigaitem[]" id="tigaitem_'+row_id+'" class="form-control" ></td>'+
          ...
          success:function(response) {
              ...
              // console.log(reponse.x);
               var html = '<tr id="row_'+row_id+'">'+
                    ...
                    '<td><input type="text" value="0" name="empatitem[]" id="empatitem_'+row_id+'" class="form-control" ></td>'+
          ...
          success:function(response) {
              ...
              // console.log(reponse.x);
               var html = '<tr id="row_'+row_id+'">'+
                    ...
                    '<td><input type="text" value="0" name="limaitem[]" id="limaitem_'+row_id+'" class="form-control" ></td>'+
          ...
          success:function(response) {
              ...
              // console.log(reponse.x);
               var html = '<tr id="row_'+row_id+'">'+
                    ...
                    '<td><input type="text" value="0" name="enamitem[]" id="enamitem_'+row_id+'" class="form-control" ></td>'+
