...
<table class="table table-bordered" id="satu_info_table">
  ...
  <thead>
              ...
              <tr>
                ...
                <th  style="background-color:#ffffff;  width:20% font-size:24px;"></th>
                <th  style="background-color:#ffffff;  width:20% font-size:24px;"></th>
                <th  style="background-color:#ffffff;  width:20% font-size:24px;"></th>
                <th  style="background-color:#ffffff;  width:20% font-size:24px;"></th>
             ...
             <tbody>
               ...
               <td style="background-color:#C0C0C0;" >
                    <input type="text" name="jsatu" id="jsatu" class="form-control" >
                   </td>
                   <th  style="background-color:#f8a649;  width:20% font-size:24px;">Sub Item </th>
                ...
                <th  style="background-color:#C0C0C0;  width:20% font-size:24px;">Metode</th>
               </tr>
               <tr id="row_1">
...
<thead>
             ...
             <tbody>
               ...
               <td>
                 ...
                 <td style="background-color:#C0C0C0;" >
                  <input type="text" name="satua" id="satua" class="form-control" >
                 </td>
                 <td style="background-color:#C0C0C0;" >
                  <input  type="text" name="satub" id="satub" class="form-control" >
                 </td>
                 <td style="background-color:#C0C0C0;" >
                  <input  type="text" name="satuc" id="jsatuc" class="form-control" >
                 </td >
                 <td style="background-color:#C0C0C0;" >
                  <input  type="text" name="satud" id="satud" class="form-control" >
                 </td>
             </tr>
                  ...
                  <thead>
                   ...
                   <tbody>
                     <tr id="row_1">
                        ...
                        <td>
                          <input type="text" name="jdua" id="jdua" class="form-control" >
                         </td>   -->
                  ...
                  <thead>
                   ...
                   <tbody>
                     <tr id="row_1">
                        ...
                        <td>
                          <input type="text" name="jtiga" id="jtiga" class="form-control" >
                         </td> -->
                 <!--       <td><input type="hidden" name="csstandard[]" id="csstandard_1" class="form-control"  ></td>
                        <td>
                          <input type="hidden" name="csfrekuensi[]" id="csfrekuensi_1" class="form-control" >
                  ...
                  <thead>
                   ...
                   <tbody>
                     <tr id="row_1">
                        ...
                        <td>
                          <input type="text" name="jempat" id="jempat" class="form-control" >
                   --> <!--       </td>
                       <td><input type="hidden" name="csstandard[]" id="csstandard_1" class="form-control"  ></td>
                        <td>
                          <input type="hidden" name="csfrekuensi[]" id="csfrekuensi_1" class="form-control" >
                  ...
                  <thead>
                   ...
                   <tbody>
                     <tr id="row_1">
                        ...
                        <td>
                          <input type="text" name="jlima" id="jlima" class="form-control" >
                    -->       </td>
                 <!--       <td><input type="hidden" name="csstandard[]" id="csstandard_1" class="form-control"  ></td>
                        <td>
                          <input type="hidden" name="csfrekuensi[]" id="csfrekuensi_1" class="form-control" >
                  ...
                  <thead>
                   ...
                   <tbody>
                     <tr id="row_1">
                        ...
                        <td>
                          <input type="text" name="jenam" id="jenam" class="form-control" >
                         </td>
        -->                 
                 <!--       <td><input type="hidden" name="csstandard[]" id="csstandard_1" class="form-control"  ></td>
                        <td>
