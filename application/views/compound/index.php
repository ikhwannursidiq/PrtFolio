      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Data Input Compound</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
...
<div class="col-md-6 col-xs-12 pull pull-left">
      <div class="form-group">
            <label for="supplier_name">Supplier Compound</label>
...
{
  if(id) {
    $("#removeCompoundForm").on('submit', function() {
      ...
      $.ajax({
        ...
        success:function(response) {
          ...
          if(response.success === true) {
            ...
            // hide the modal
            $("#removeCompoundModal").modal('hide');
