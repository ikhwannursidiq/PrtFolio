      ...
      <div class="col-md-12 col-xs-12">
        ...
        <table class="styled-table">
                ...
                <tr class="active-row">
                    ...
                    <td width="2%" ><input type="text" class="form-control" id="hsmin" name="hsmin"  onchange="statusCompound()" autocomplete="off" ></td>
                    <td width="2%"><input type="text" class="form-control" id="hsmax" name="hsmax"  onchange="statusCompound()" autocomplete="off" ></td>
                    ...
                    <td width="20%"><select class="form-control" id="hsst_value" name="hsst_value" >
                ...
                <tr class="active-row">
                   <td  class="active-row"> <label for="telp">TENSILE BREAK (TB)</label></td>
                    ...
                    <td><input type="text" class="form-control" id="tbmin" name="tbmin" onchange="statustb()" autocomplete="off"></td>
                    <td><input type="text" class="form-control" id="tbmax" name="tbmax" onchange="statustb()" autocomplete="off"></td>
                    ...
                    <td><select class="form-control" id="tbst_value" name="tbst_value" >
                        <option value="1">OK</option>
                        <option value="0">NG</option>
                        </select>
                    </td> 
                ...
                <tr class="active-row">
                   <td  class="active-row"> <label for="telp">ELONGATION BREAK (EB)</label></td>
                    ...
                    <td><input type="text" class="form-control" id="ebmin" name="ebmin"  onchange="statuseb()" autocomplete="off"></td>
                    <td><input type="text" class="form-control" id="ebmax" name="ebmax"  onchange="statuseb()" autocomplete="off"></td>
                    ...
                    <td><select class="form-control" id="ebst_value" name="ebst_value" >
                        <option value="1">OK</option>
                        <option value="0">NG</option>
                        </select>
                    </td> 
                ...
                <tr class="active-row">
                   <td  class="active-row"> <label for="telp">SPESIFIC GRAFITY</label></td>
                    ...
                    <td><input type="text" class="form-control" id="sgmin" name="sgmin" onchange="statussg()" autocomplete="off"></td>
                    <td><input type="text" class="form-control" id="sgmax" name="sgmax" onchange="statussg()" autocomplete="off"></td>
                   ...
                   <td><select class="form-control" id="sgst_value" name="sgst_value" >
                        <option value="1">OK</option>
                        <option value="0">NG</option>
                        </select>
                    </td> 
