...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Manage
      <small>Poimport</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Poimport</li>
    </ol>
  </section>
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Edit Poimport</h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('poimport/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
 ...
 <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_name_1" name="customer_name" value="<?php echo $poimpor_data['poimport']['customer_name'] ?>" placeholder="Enter Customer Address" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Customer Address</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_address_1" name="customer_address" value="<?php echo $poimpor_data['poimport']['customer_address'] ?>" placeholder="Enter Customer Address" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_phone_1" name="customer_phone" value="<?php echo $poimpor_data['poimport']['customer_phone'] ?>" placeholder="Enter Customer Phone" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="fax" class="col-sm-5 control-label" style="text-align:left;">FAX</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="fax_1" name="fax" value="<?php echo $poimpor_data['poimport']['fax'] ?>" placeholder="Enter Customerfax" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="attn" class="col-sm-5 control-label" style="text-align:left;">Atas Nama</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="attn_1" name="attn" value="<?php echo $poimpor_data['poimport']['attn'] ?>" placeholder="Enter attn" autocomplete="off">
                    </div>
                  </div>
                ...
                <table class="table table-bordered" id="product_info_table">
                  <thead>
                   ...
                   <tbody>
                    ...
                    <?php if(isset($poimpor_data['poimpor_item'])): ?>
                      <?php $x = 1; ?>
                      <?php foreach ($poimpor_data['poimpor_item'] as $key => $val): ?>
                        <?php //print_r($v); ?>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="gross_amount" name="gross_amount" disabled value="<?php echo $poimpor_data['poimport']['gross_amount'] ?>" autocomplete="off">
                      <input type="hidden" class="form-control" id="gross_amount_value" name="gross_amount_value" value="<?php echo $poimpor_data['poimport']['gross_amount'] ?>" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="service_charge" name="service_charge" disabled value="<?php echo $poimpor_data['poimport']['service_charge'] ?>" autocomplete="off">
                      <input type="hidden" class="form-control" id="service_charge_value" name="service_charge_value" value="<?php echo $poimpor_data['poimport']['service_charge'] ?>" autocomplete="off">
                    </div>
                  </div>
                  <?php endif; ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="vat_charge" name="vat_charge" disabled value="<?php echo $poimpor_data['poimport']['vat_charge'] ?>" autocomplete="off">
                      <input type="hidden" class="form-control" id="vat_charge_value" name="vat_charge_value" value="<?php echo $poimpor_data['poimport']['vat_charge'] ?>" autocomplete="off">
                    </div>
                  </div>
                  <?php endif; ?>
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="discount" name="discount" placeholder="Discount" onkeyup="subAmount()" value="<?php echo $poimpor_data['poimport']['discount'] ?>" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="net_amount" class="col-sm-5 control-label">Net Amount</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="net_amount" name="net_amount" disabled value="<?php echo $poimpor_data['poimport']['net_amount'] ?>" autocomplete="off">
                      <input type="hidden" class="form-control" id="net_amount_value" name="net_amount_value" value="<?php echo $poimpor_data['poimport']['net_amount'] ?>" autocomplete="off">
                    </div>
                  </div>
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo base_url() . 'poimport/printDiv/'.$poimpor_data['poimport']['id'] ?>" class="btn btn-default" >Print</a>
                <button type="submit" class="btn btn-primary">Save Changes</button>
                <a href="<?php echo base_url('poimport/') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
...
<script type="text/javascript">
  ...
  //   if(id) {
  //     $.ajax({
  //       url: base_url + 'poimport/printDiv/' + id,
  //       type: 'post',
  ...
  $(document).ready(function() {
    ...
    $("#managePoimportNav").addClass('active');
    ...
    $("#add_row").unbind('click').bind('click', function() {
      ...
      $.ajax({
          url: base_url + '/poimport/getTableProductRow/',
          type: 'post',
          dataType: 'json',
          success:function(response) {
  ...
  function getProductData(row_id)
  {
    ...
    if(product_id == "") {
      ...
      $.ajax({
        url: base_url + 'poimport/getProductValueById',
        type: 'post',
  ...
  // calculate the total amount of the poimport
  function subAmount() {
