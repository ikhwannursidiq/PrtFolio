			...
			<div class="box">
				...
				<div class="box-body">
				  ...
				  <div class="col-md-4">
					 ...
					 <label>IRD</label>
	  <select name="id_rfq" class="form-control select2" data-placeholder="Pilih RFQ" onchange="location = '<?php echo base_url();?>rfqs/po_tambah/'+this.value;" required >
		  <?php if($this->uri->segment(3)!=''){
			  echo "<option value='$tbl_rfq_by->id'>$tbl_rfq_by->id $tbl_rfq_by->customer_name</option>";
		  }else{
			  echo "<option>Pilih RFQ</option>";
		  } ?>
		  <?php foreach($rfqs as $rfq){?>
			  <option value="<?php echo $rfq->id;?>"> <?php echo $rfq->pono;?></option>
		  <?php } ?>
	  </select>
	  </div>
				</div>
		...
		<table class="table table-bordered" >
              ...
              <td style="background-color:#F4A460; width:50%"> 
                 ...
                 <div class="form-group">
                    <label for="gross_amount" class="col-sm-3 control-label" style="text-align:left;">Customer </label>
                		<div class="col-sm-8">
						<input type="text" class="form-control" name="customer" placeholder="Customer" value="<?php if ($this->uri->segment(3)!=''){ echo $tbl_rfq_by->customer_name; }else { echo"";}?>">
                		</div>
				<br><br>
                <label for="gross_amount" class="col-sm-3 control-label" style="text-align:left;">Part Name </label>
                    	<div class="col-sm-8">
						<input type="text" class="form-control" name="partname" placeholder="Partname" value="<?php if ($this->uri->segment(3)!=''){ echo $tbl_rfq_by->pono; }else { echo"";}?>">
                    	</div>
				<br><br>
                <label for="gross_amount" class="col-sm-3 control-label" style="text-align:left;">Part Number </label>
                    	<div class="col-sm-8">
						<input type="text" class="form-control" name="partno" placeholder="Partno" value="<?php if ($this->uri->segment(3)!=''){ echo $tbl_rfq_by->customer_name; }else { echo"";}?>">
                    	</div>		
			...
			<td>
				...
				<div class="form-group">
                    <label for="gross_amount" class="col-sm-3 control-label" style="text-align:left;">Date </label>
                		<div class="col-sm-8">
						<input type="date" class="form-control" name="tanggal_po" value="<?php if ($this->uri->segment(3)!=''){ echo $tbl_rfq_by->customer_name; }else { echo"";}?>">
                		</div>
				<br><br>
                <label for="gross_amount" class="col-sm-3 control-label" style="text-align:left;">Material </label>
                    	<div class="col-sm-8">
						<input type="text" class="form-control" name="material" placeholder="Material" value="<?php if ($this->uri->segment(3)!=''){ echo $tbl_rfq_by->customer_name; }else { echo"";}?>">
                    	</div>
				<br><br>
                <label for="gross_amount" class="col-sm-3 control-label" style="text-align:left;">Lot Number </label>
                    	<div class="col-sm-8">
						<input type="text" class="form-control" name="nolot" placeholder="No Lot" value="<?php if ($this->uri->segment(3)!=''){ echo $tbl_rfq_by->customer_name; }else { echo"";}?>">
                    	</div>		
...
<td style="background-color:#F4A460; font-size:20px; width:10%;" align="center"rowspan ="2"><b>  Standart</b></td>
										...
										if($this->uri->segment(3)!=''){
											...
											foreach($rfqs_item as $detail){ ?>
												<tr id='tambahproduklainnyadiv<?php echo $x;?>' >
													...
													<td>
														<input type="text" class="form-control" id="rata<?php echo $x;?>" name="rata[]" required onkeyup="getTotal(<?php echo $x; ?>)"  placeholder="" >
													</td>
													<td>
														<input type="text" class="form-control" id="selisih<?php echo $x;?>" name="selisih[]" placeholder="" value="0">
													</td>
												</tr>
											<?php $x++; }
...
<textarea class="form-control" rows="4" name="alamat_pengiriman_po" placeholder="tulis apa saja, asal sopan"></textarea>
...
<td style="background-color:#778899;"  align="center" rowspan="1"  colspan="6" > 
<select name="tax_po" class="form-control select2" data-placeholder="Pilih Result" required >
							<option value="0">Waiting</option>
							<option value="5">OK</option>
							<option value="10">NG</option>
						</select>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        $("#satu, #dua, #tiga, #empat, #lima, #rata").keyup(function() { 
	...
	//var selisih2 = $("#selisih").val();  

   var total = parseInt(satu) + parseInt (dua) + parseInt (tiga) + parseInt (empat) + parseInt (lima) ;    
   var rata = parseInt(total)/5 
 	$("#rata").val(rata);  

      //  var partok  = $("#ok").val(); 
        //var partng = $("#ng").val(); 
        var gab = parseInt(maksimal) + parseInt(minimal);
