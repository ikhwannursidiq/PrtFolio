              ...
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="picname" name="picname" placeholder="Enter Customer Name" autocomplete="off" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="date" class="form-control" id="dateinspection" name="dateinspection" placeholder="Enter Customer Phone" autocomplete="off">
                    </div>
                  </div>
                </div>
                ...
                <table class="table table-bordered" id="product_info_table">
                  <thead>
                    ...
                    <th style="width:20%">SELECT PART NO</th>
                      <th style="width:15%">PART NO</th>
                      <th style="width:10%">QTY</th>
                      <th style="width:10%">CT/PCS</th>
                      <th style="width:10%">TOTAL</th>
                      <th style="width:20%">TOTAL JAM KERJA</th>
...
<script type="text/javascript">
  ...
  function getTotal(row = null) {
    if(row) {
      ...
      var ttjk = Number(total)*0.00036;
              ttjk = ttjk.toFixed(0.00);
