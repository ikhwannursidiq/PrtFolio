   ...
   <tr>
            ...
            <select class="form-control select_group customer" name="trialno" id="trialno" class="form-control" required onkeyup="getTotal(1)">
              ...
              <option value="Trial 7">Trial 7</option>
                ...
                <tr>
                      <td class="round4" colspan="2" align="Left" style="background-color:#ffffff; width:10% font-size:20px;" ><b>Part No</b></td>                    
                      <td class="round3" colspan="4" align="center" style="background-color:#fada5e; width:5% ; font-size:16px;"><input type="text" name="partno" id="partno" class="form-control" ></td>
                      ...
                      <td class="round3" colspan="2" align="center" style="background-color:#fada5e;" ><b><input type="date" name="date_created" id="date_created" class="form-control" ></b></td>
                      
                 </tr>
                 <tr>
                      <td class="round4" colspan="2" align="Left" style="background-color:#fffffff; width:10% font-size:20px;" ><b>Part Name</b></td>                    
                      <td class="round3" colspan="4" align="center" style="background-color:#fada5e; width:5% ; font-size:16px;"><input type="text" name="partname" id="partname" class="form-control" ></td>                    
                       <td  align="center" style="background-color:#ffffff; width:2% ; font-size:16px;"><b></td> 
                      ...
                      <td class="round3" colspan="4"  align="center" style="background-color:#fada5e;" ><b>
                 ...
                 <tr>
                      ...
                      <td class="round3" colspan="4" align="center" style="background-color:#fada5e; width:5% ; font-size:16px;"><input type="text" name="type" id="type" class="form-control" ></td>                    
                       <td  align="center" style="background-color:#ffffff; width:2% ; font-size:16px;"><b></td> 
                     ...
                     <td class="round3" colspan="4"  align="center" style="background-color:#fada5e;" ><b><input type="text"  name="wsfabric" id="wsfabric" class="form-control" ></b></td>            
                 </tr>

                 <tr>
                      <td colspan="2" align="Left" style="background-color:#00CED1; width:10% font-size:20px;" ><b>Safety Part</b></td>                    
                      <td class="round3" colspan="4" align="center" style="background-color:#fada5e; width:5% ; font-size:16px;"> 
                 ...
                 <tr>
                  ...
                  <td colspan="2" rowspan="2" align="center" style="background-color:#00CED1;" ><b>Mandrell / Roll</b></td>    
                 ...
                 <tr>
                      ...
                      <td class="round3" colspan="2" align="center" style="background-color:#fada5e; width:5% ; font-size:16px;"> 
                      <select class="form-control select_group customer" name="wemr" id="wemr" class="form-control" >
							              
                            <option value="Roll" >Roll</option> 
                            <option value="Mandrel" >Mandrel</option>
                      </select> 
                    </td>                     
                      <td colspan="" align="center" style="background-color:#fada5e; width:5% ; font-size:16px;"><input type="text" name="mqty" id="mqty" class="form-control" disabled="disabled" ></td>                    
                      <td colspan="" align="center" style="background-color:#fada5e; width:5% ; font-size:16px;"><input type="text" name="cavity" id="cavity" class="form-control" disabled="disabled" ></td>                     
...
<br>
      ...
      <tr>
                ...
                <tr id = "myForm">
                    <td  align="center" style="background-color:#8FBC8F; width:5% ; font-size:16px;"><input type="checkbox" name="emcontinous" value="Continous" id="checkboxOne" /> </td>
                    <td  align="center" style="background-color:#fada5e; width:5% ; font-size:16px;"> <input type="checkbox" name="embasichose" value="Basichose" id="checkboxTwo" /></td>
                    <td  align="center" style="background-color:#fada5e; width:5% ; font-size:16px;"> <input type="checkbox" name="emsinglelayer" value="Singlelayer" id="checkboxThree" /></td>
      </tr>
      <tr>             
  ...
  <table class="table table-border" id="product_info_table">
      ...
      <tr>
                  ...
                  <tr>
                    ...
                    <td  align="center" style="background-color:#fada5e; width:5% ; font-size:16px;"><input type="text" value="0" step="0.01" name="wipbh" id="wipbh" class="form-control" ></td>
                    <td  align="center" style="background-color:#8FBC8F;  width:5% ; font-size:16px;"><input type="text" value="0" step="0.01" name="wipcover" id="wipcover" class="form-control" ></td>
                    <td  align="center" style="background-color:#fada5e; width:5% ; font-size:16px;"><input type="text" value="0" step="0.01"  name="wipthread" id="wipthread" class="form-control" ></td>
                    <td  align="center" style="background-color:#fada5e; width:5% ; font-size:16px;"><input type="text" value="0" step="0.01" name="wiptotal" id="wiptotal" class="form-control" required onkeyup="getWip(1)"></td>
  ...
  <table class="table table-border" id="product_info_table">
      <tr>
                  ...
                  <select class="form-control select_group customer" name="brtype" id="brtypa" class="form-control" required onkeyup="getTotal(1)">
                    ...
                    <td colspan="2" align="center" style="background-color:#fada5e; width:5% ; font-size:16px;"><input type="text" step="0.01" value="0" name="ectrata" id="ectrata" class="form-control" required onkeyup="getect"></td>             
                  </tr>
  </table>
...
<table class="table table-border" id="product_info_table">
                <tr>
				   ...
				   <td  align="center" colspan="4" style="background-color:#fada5e; width:10% ; font-size:16px;"><b>Auto Clave No<b>
                    </td>
                    <td  align="center" colspan="2" style="background-color:#fada5e; width:10% ; font-size:16px;"><b><select class="form-control select_group customer" name="pa" id="pa" class="form-control" required onkeyup="getTotal(1)">
							      <option value="NO">NO </option>
                    <option value="YES">YES</option>
                             
                    </select><b>
                    </td>
                    <td  align="center" colspan="3" style="background-color:#fada5e; width:10% ; font-size:16px;"><b>Poscuring<b>
               ...
               <tr>
                ...
                <!-- select autoclave -->
                    <td  align="center" style="background-color:#8FBC8F; width:5% ; font-size:16px;">
                    <select class="form-control select_group customer" name="autosatu" id="autosatu" class="form-control" disabled="disabled">
							      <option > </option>
                   ...
                   <td  align="center" style="background-color:#fada5e; width:5% ; font-size:16px;">
                   <select class="form-control select_group customer" name="autodua" id="autodua" class="form-control" disabled="disabled">
							      <option > </option>
                    ...
                    <select class="form-control select_group customer" name="autotiga" id="autotiga" class="form-control" disabled="disabled">
							       <option > </option>
                    ...
                    <td  align="center" style="background-color:#8FBC8F; width:5% ; font-size:16px;">
                    <select class="form-control select_group customer" name="autoempat" id="autoempat" class="form-control" disabled="disabled">
							      <option > </option>
                   ...
                   <td  align="center" style="background-color:#fada5e; width:5% ; font-size:16px;">
                   <select class="form-control select_group customer" name="autolima" id="autolima" class="form-control" disabled="disabled">
							        <option > </option>
                    ...
                    <td  align="center" colspan="" style="background-color:#8FBC8F; width:5% ; font-size:16px;">
                    <select class="form-control select_group customer" name="autoenam" id="autoenam" class="form-control" disabled="disabled">
							      <option > </option>
                ...
                <!-- select poscuring -->
                    <td  align="center" colspan="3" style="background-color:#fada5e; width:5% ; font-size:16px;">
                    <select class="form-control select_group customer" name="ppc" id="ppc" class="form-control" required onkeyup="getTotal(1)">
							      <option value="NO">NO </option>
                    <option value="YES">YES</option>
               ...
               <tr>
                   ...
                   <!-- select autoclave -->
                   <td  align="center" style="background-color:#8FBC8F; width:5% ; font-size:16px;">
                    <select class="form-control select_group customer" name="autotujuh" id="autotujuh" class="form-control" disabled="disabled">
							      <option > </option>
                   ...
                   <td  align="center" style="background-color:#fada5e; width:5% ; font-size:16px;">
                   <select class="form-control select_group customer" name="autodelapan" id="autodelapan" class="form-control" disabled="disabled">
							       <option > </option>
                    ...
                    <td  align="center" colspan="" style="background-color:#8FBC8F; width:5% ; font-size:16px;">
                    <select class="form-control select_group customer" name="autosembilan" id="autosembilan" class="form-control" disabled="disabled">
							       <option > </option>
                    ...
                    <td  align="center" style="background-color:#8FBC8F; width:5% ; font-size:16px;">
                    <select class="form-control select_group customer" name="autosepuluh" id="autosepuluh" class="form-control" disabled="disabled">
							       <option > </option>
                   ...
                   <td  align="center" style="background-color:#fada5e; width:5% ; font-size:16px;">
                   <select class="form-control select_group customer" name="autosebelas" id="autosebelas" class="form-control" disabled="disabled">
							       <option > </option>
                    ...
                    <td  align="center" colspan="" style="background-color:#8FBC8F; width:5% ; font-size:16px;">
                    <select class="form-control select_group customer" name="autoduabelas" id="autoduabelas" class="form-control" disabled="disabled">
							        <option > </option>
                ...
                <!-- select poscuring -->
                <td  align="center" style="background-color:#fada5e; width:5% ; font-size:16px;">
                    <select class="form-control select_group customer" name="possatu" id="possatu" class="form-control" disabled="disabled" >
							       <option > </option>
                   ...
                   <td  align="center" style="background-color:#fada5e; width:5% ; font-size:16px;">
                   <select class="form-control select_group customer" name="posdua" id="posdua" class="form-control" disabled="disabled" >
							        <option > </option>
                    ...
                    <select class="form-control select_group customer" name="postiga" id="postiga" class="form-control" disabled="disabled" >
							       <option > </option>
...
<td style="background-color:#F4A460; width:50%"> 
 ...
 <div class="form-group">
    ...
    <select class="form-control select_group customer" name="prepared" id="prepared" class="form-control"  onkeyup="getTotal(1)">
							              <option value="1">EKI</option>
                           
                            <option value="2">DZULQIFLY</option>              
    </select>
    </div>
	...
	<select class="form-control select_group customer" name="trialresult" id="trialresult" class="form-control" required onkeyup="getTotal(1)">
							  <option align="center" value="1">OK</option>
               <option align="center" value="2">NG</option>
                      </select>
  ...
  <label for="gross_amount" class="col-sm-2 control-label" style="text-align:center;background-color:#008cba;">CHECKED</label>
    ...
    <option value="0">Waiting</option>
                            <option value="1">ZALIL</option>
                            <option value="2">JAJANG S</option>  
