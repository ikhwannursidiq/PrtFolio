    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createPoumum', $user_permission)): ?>
          <a href="<?php echo base_url('qcreports/') ?>" class="btn btn-primary">Add Poumum</a>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Manage REPOR TQC</h3>
          </div>
<!-- TABEL RECORD -->
      <!-- /.box-header -->
          <div class="box-body">
...
<script type="text/javascript">
 ...
 $("#mainQcreportsNav").addClass('active');
  $("#addQcreportNav").addClass('active');
