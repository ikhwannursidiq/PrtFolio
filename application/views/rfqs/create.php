...
<!-- /.header invoice -->
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control"  value="<?php echo  date("j F Y, G:i");?>" id="deliverydate" name="deliverydate" placeholder="Enter Date" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="deliverydate" class="col-sm-5 control-label" style="text-align:RIGHT;">Due Date</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control"  value="<?php echo  date(" F j Y, G:i");?>" id="duedate" name="duedate" placeholder="Enter Date" autocomplete="off">
                    </div>
                  </div>
          </div>
          <!-- /footer invoice -->      
                ...
                <table class="table table-bordered" id="product_info_table">
                  <thead>
                   ...
                   <tbody>
                     <tr id="row_1">
                        <td><input type="text" name="product[]" id="product_1" class="form-control"></td>
                        <td><input type="text" name="partname[]" id="partname_1" class="form-control"></td>
                        <td><input type="text" name="qty[]" id="qty_1" class="form-control" ></td>
                        <td><input type="text" name="unit[]" id="unit_1" class="form-control" ></td>
