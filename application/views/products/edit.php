        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="price">Mix</label>
                  <input type="text" class="form-control" id="mix" name="mix" placeholder="Enter mix" value="<?php echo $product_data['mix']; ?>" autocomplete="off" />
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="unit" name="unit" placeholder="Enter price" value="<?php echo $product_data['unit']; ?>" autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="description">Description</label>
                  <input type="text" class="form-control" id="description" name="description" placeholder="Enterdescription" value=" <?php echo $product_data['description']; ?>" autocomplete="off" />
