                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="input-group mb-12">
                            ...
                            <input type="text" class="form-control" id="start_date" placeholder="Start Date" value="2023-04-01" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="input-group mb-12">
                            ...
                            <input type="text" class="form-control" id="end_date" placeholder="End Date" value="2023-04-06"  readonly>
                        </div>
                    </div>
                </div>
        </div>
...
records = $('#records').DataTable({
   // 'ajax': base_url + 'items/fetchFincomingData',
...
function fetch(start_date, end_date) {
        $.ajax({
            ...
            url: '<?php echo site_url('items/records') ?>',
