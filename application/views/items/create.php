    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('items/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Enter part no" autocomplete="off"/>
                </div>

                <div class="form-group">
                  <label for="sku">Part No</label>
                  <input type="text" class="form-control" id="sku" name="sku" placeholder="Enter part no" autocomplete="off" />
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="price" name="price" placeholder="Enter tipe" autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="qty">Material</label>
                  <input type="text" class="form-control" id="qty" name="qty" placeholder="Enter material" autocomplete="off" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select_group" id="operator" name="operator">
