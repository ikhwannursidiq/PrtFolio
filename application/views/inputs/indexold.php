...
<div class="col-md-12 ">   
  <div class="box">
    ...
    <div class="form-group">            
          ...
          <div class="col-sm-3">
                    <label for="deliverydate">Part No</label>
                      <input type="text"  class="form-control"  id="nama" name="nama" placeholder="Enter nama" required >
            </div>
          <div class="col-sm-3">
                    <label for="deliverydate">No Lot (format : 22-01-2022 3.01)</label>
                      <input type="text"  class="form-control" required  id="nolot" name="nolot" placeholder="Enter LOT" required minlength="15" maxlength="15" size="15" autocomplete="off">
            </div>
            ...
            <div class="col-sm-3">
                    <label for="deliverydate">Date sistem</label>
                      <input type="text"  class="form-control"  value="<?php echo  date("Y-m-d");?>" id="date_time" name="date_time" placeholder="Enter Date" autocomplete="off" disabled>
            </div>
        </div> 
...
$(document).ready(function() {
 ...
 $(document).ready(function() {
        $("#sempit, #seret, #ok, #ng, #goresan, #tidaknempel, #kebentur, #saringanjebol, #gelembung, #bintik, #lukadalam, #lukaluar, #retak, #bergaris, #hosependek, #oper, #wrappingan, #braidingan, #bolong, #tipis, #karetnempel, #tebal, #porisiti, #bekastangan, #sobek, #oval, #benangrusak, #siwak, #keropos, #holetube, #springpendek, #diameterkecil, #others ").keyup(function() { 
