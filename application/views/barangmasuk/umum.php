      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Add Pocompound</h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('Pocompound/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
				...
				<tr id="rw_1">
					   ...
					   <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Customer Name</label>
					    <td>
                        <select class="form-control select_group product" data-row-id="rw_1" id="vroduct_1" name="vroduct[]" style="width:100%;" onchange="getVroductData(1)" required>
                            <option value=""></option>
                            <?php foreach ($vroducts as $k => $v): ?>
						...
						<label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Customer Address</label>
						  ...
						  <input type="text" name="mi[]" id="mi_1" class="form-control" disabled autocomplete="off">
                        </div>
                  ...
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Customer Name</label>
                    <div class="col-sm-7">
                    <select class="form-control select_group customer" id="customer_name" name="customer_name" style="width:100%;" >
                    <option value=""></option>
			
                            <?php foreach ($vroducts as $v): ?>
                              <option value="<?php echo $v['id'] ?>"><?php echo $v['name'] ?></option>
                            <?php endforeach ?>
                            </select>
                     </div>
              ...
              <div class="box-footer">
                ...
                <button type="submit" formnovalidate class="btn btn-success" >Create Pocompound</button>
...
<script type="text/javascript">
  ...
  {
    var vroduct_id = $("#vroduct_"+rw_id).val();    
    if(vroduct_id == "") {
      $("#mi_"+rw_id).val("");
