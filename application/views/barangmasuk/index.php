    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <table id="manageTable" class="table table-bordered table-warning">
              <thead>
              <tr>
     ...
     <!--           <th style="background-color:#1c87c9;"  width="20%" rowspan="2">Action</th>
        -->  </tr>
              <tr>
                ...
                <?php if(in_array('updateBarangmasuk', $user_permission) || in_array('viewBarangmasuk', $user_permission) || in_array('deleteBarangmasuk', $user_permission)): ?> 
