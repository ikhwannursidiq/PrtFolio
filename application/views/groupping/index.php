...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Manage
      <small>Laporan Ke Gudang</small>
   
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Laporan Ke Gudang</li>
    </ol>
  </section>
    ...
    function fetch(start_date, end_date) {
        $.ajax({
          ...
          //  url: "http:localhost/qc/exports/records",
            url: '<?php echo site_url('groupping/records') ?>',
          ...
          // url:'http://localhost/qc/daterange/records',
            ...
            success: function(data) {
                ...
                $('#records').DataTable({
                    ...
                    // responsive
                    "responsive": true,
                    "lengthMenu": [[25, 50, 100,500,1000,2000,10000 -1], [25, 50, 100, 500, 1000, 2000,10000 ]],
                    "columns": [{
                            "data": "id",
