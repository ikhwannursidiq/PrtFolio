      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Input Return Part</h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('balikan/create') ?>" method="post" class="form-horizontal">
           ...
           <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_name" name="customer_name" placeholder="Enter Customer Address" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:right;">PIC Name</label>
                    <div class="col-sm-7">
...
<div class="col-md-4 col-xs-12 pull pull-left">
                ...
                <table class="table table-bordered" id="product_info_table">
                  <thead>
                   ...
                   <tr id="row_1">
                        ...
                        <td>
                        <select class="form-control select_group product" data-row-id="row_1" id="product_1" name="product[]" style="width:100%;" onchange="getItemData(1)" required>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="total_qty" name="total_qty" disabled autocomplete="off">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('Polokal/') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
