...
class Model_trial extends CI_Model
{
	...
	/* get the brand data */
	public function getTrialData($id = null)
	{
		if($id) {
	...
	public function getActiveTrialData()
	{
  ...
  public function getTrialItemData($trial_id = null)
	{
		if(!$trial_id) {
			return false;
		}
  ...
  public function getTrialItemDataDua($trial_id = null)
	...
	public function getTrialCheckProdukjadi($trial_id = null)
	{
		if(!$trial_id) {
			return false;
		}
	...
	public function getTrialCheckMaterial($trial_id = null)
	{
		if(!$trial_id) {
			return false;
		}
	...
	public function getTrialCheckPerformance($trial_id = null)
	{
		if(!$trial_id) {
			return false;
		}
  ...
  public function getTrialBra($trial_id = null)
	{
		if(!$trial_id) {
			return false;
		}
