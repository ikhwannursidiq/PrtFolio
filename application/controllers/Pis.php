...
class Pis extends Admin_Controller 
{
	...
	*/
	...
	{
		if(!in_array('viewPi', $this->permission)) {
			redirect('dashboard', 'refresh');
		}

		$result = $this->model_pis->getInputData();
...
//menampilkan data Items
		...
		$this->render_template('pis/index', $this->data);
	}
