...
class Qcreportsgudang extends Admin_Controller 
{
	...
	*/
	...
	{
		if(!in_array('viewQcreportGudang', $this->permission)) {
...
//menampilkan data Items
	//	$this->data['items'] = $this->model_items->getActiveItemData();      	
		...
		$this->render_template('qcreports/reportgudang', $this->data);
	}
	...
	*/
    ...
    {
        $json = array();    
        $list = $this->model_inputs->getQueryInputData();
        $data = array();
